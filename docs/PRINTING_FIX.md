...
```
❌ Cannot connect to FCUBS SOAP endpoint: http://10.250.100.40:8000/api
```

**السبب**: النظام يحاول الاتصال بخادم FCUBS SOAP على `http://10.250.100.40:8000/api` لكن الخادم غير متاح.
