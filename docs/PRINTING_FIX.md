...
```
❌ Cannot connect to FCUBS SOAP endpoint: http://localhost:5000:8000/api
```

**السبب**: النظام يحاول الاتصال بخادم FCUBS SOAP على `http://localhost:5000:8000/api` لكن الخادم غير متاح.
...
جرب الآن:
1. افتح صفحة الطباعة: `http://localhost:5000/print`
