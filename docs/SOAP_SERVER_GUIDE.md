...
🏥 Health Check: http://10.250.100.40:5000:8080/health
```
...
curl http://10.250.100.40:5000:8080/health
```
...
1. **افتح صفحة الطباعة**: `http://10.250.100.40:5000/print`
...
2. ✅ تحقق من `http://10.250.100.40:5000:8080/health`
