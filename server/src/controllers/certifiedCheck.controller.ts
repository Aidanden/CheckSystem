...
export const updateSettings = async (req: Request, res: Response) => {
    try {
        ...
        const settings = await PrintSettingsModel.upsert({
            ...
            branchNameX: data.branchName?.x ?? data.branchNameX ?? 110,
            branchNameY: data.branchName?.y ?? data.branchNameY ?? 4,
            ...
            serialNumberX: data.serialNumber?.x ?? data.serialNumberX ?? 185,
            ...
            serialNumberAlign: data.serialNumber?.align ?? data.serialNumberAlign ?? 'left',
            accountNumberX: data.accountNumberX ?? data.accountNumber?.x ?? 30,
            accountNumberY: data.accountNumberY ?? data.accountNumber?.y ?? 12,
            accountNumberFontSize: data.accountNumberFontSize ?? data.accountNumber?.fontSize ?? 8,
            accountNumberAlign: data.accountNumberAlign ?? data.accountNumber?.align ?? 'right',
            ...
            accountHolderNameX: data.accountHolderNameX ?? data.accountHolderName?.x ?? 30,
            accountHolderNameY: data.accountHolderNameY ?? data.accountHolderName?.y ?? 18,
            accountHolderNameFontSize: data.accountHolderNameFontSize ?? data.accountHolderName?.fontSize ?? 8,
            accountHolderNameAlign: data.accountHolderNameAlign ?? data.accountHolderName?.align ?? 'right',
            micrLineX: data.micrLineX ?? data.micrLine?.x ?? 138.5,
            micrLineY: data.micrLineY ?? data.micrLine?.y ?? 75,
            ...
            // New fields
            beneficiaryNameX: data.beneficiaryNameX ?? data.beneficiaryName?.x ?? 155,
            beneficiaryNameY: data.beneficiaryNameY ?? data.beneficiaryName?.y ?? 41,
            beneficiaryNameFontSize: data.beneficiaryNameFontSize ?? data.beneficiaryName?.fontSize ?? 8,
            beneficiaryNameAlign: data.beneficiaryNameAlign ?? data.beneficiaryName?.align ?? 'right',
            amountNumbersX: data.amountNumbersX ?? data.amountNumbers?.x ?? 200,
            amountNumbersY: data.amountNumbersY ?? data.amountNumbers?.y ?? 42,
            amountNumbersFontSize: data.amountNumbersFontSize ?? data.amountNumbers?.fontSize ?? 8,
            amountNumbersAlign: data.amountNumbersAlign ?? data.amountNumbers?.align ?? 'right',
            amountWordsX: data.amountWordsX ?? data.amountWords?.x ?? 117.5,
            amountWordsY: data.amountWordsY ?? data.amountWords?.y ?? 48,
            amountWordsFontSize: data.amountWordsFontSize ?? data.amountWords?.fontSize ?? 8,
            amountWordsAlign: data.amountWordsAlign ?? data.amountWords?.align ?? 'center',
            issueDateX: data.issueDateX ?? data.issueDate?.x ?? 185,
            issueDateY: data.issueDateY ?? data.issueDate?.y ?? 12,
            issueDateFontSize: data.issueDateFontSize ?? data.issueDate?.fontSize ?? 8,
            issueDateAlign: data.issueDateAlign ?? data.issueDate?.align ?? 'left',
            checkTypeX: data.checkTypeX ?? data.checkType?.x ?? 120,
            checkTypeY: data.checkTypeY ?? data.checkType?.y ?? 10,
            checkTypeFontSize: data.checkTypeFontSize ?? data.checkType?.fontSize ?? 8,
            checkTypeAlign: data.checkTypeAlign ?? data.checkType?.align ?? 'center',
            checkNumberX: data.checkNumberX ?? data.checkNumber?.x ?? 185,
            checkNumberY: data.checkNumberY ?? data.checkNumber?.y ?? 18,
            checkNumberFontSize: data.checkNumberFontSize ?? data.checkNumber?.fontSize ?? 8,
            checkNumberAlign: data.checkNumberAlign ?? data.checkNumber?.align ?? 'left',
        });
